...
class ClinicJobs(Model):
    ...
    svep_status = UnicodeAttribute(default="")
    svep_failed_step = UnicodeAttribute(default="")
    svep_error_message = UnicodeAttribute(default="")
    pharmcat_status = UnicodeAttribute(default="")
    pharmcat_failed_step = UnicodeAttribute(default="")
    pharmcat_error_message = UnicodeAttribute(default="")
    lookup_status = UnicodeAttribute(default="")
    lookup_failed_step = UnicodeAttribute(default="")
    lookup_error_message = UnicodeAttribute(default="")
