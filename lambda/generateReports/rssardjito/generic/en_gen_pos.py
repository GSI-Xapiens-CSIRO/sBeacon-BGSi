...
def _create_annotations(
    ...
    _static_text_page_2 = [
        ...
        (538, 248, 11, True, validated_by),
        (538, 216, 11, True,  validated_at),
    ]
    _static_text_page_3 = []
    _static_text_page_4 = [
        # ClinVar
...
def generate(
    *,
    ...
    input_pdf_path = f"{module_dir}/EN_Genome Report_Positive-TABLE.pdf"
    ...
    _overlay_pdf_with_annotations(
        ...
        f"{module_dir}/EN_Genome Report_Positive-REST.pdf",
    ...
    result_file_name = f"/tmp/annotated_gen_pos-{str(uuid.uuid4())}.pdf"
