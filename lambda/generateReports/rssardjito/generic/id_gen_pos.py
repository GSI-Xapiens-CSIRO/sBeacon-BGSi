...
def _write_header_footer(filename, pages, pii_name, pii_dob, pii_gender, report_id):
    ...
    c.drawString(72, 551, f"Kondisi Klinis:")
    form.textfield(
    ...
    for page in range(pages):
        ...
        c.drawString(290, 30, f"Halaman {page+1} dari {pages}")
        c.showPage()
    c.save()
...
def _create_annotations(
    ...
    _static_text_page_4 = [
        # OMIM
        (170, 479 - 53, 11, versions["omim_version"]),
        # ClinVar
        (170, 467 - 53, 11, versions["clinvar_version"]),
        # gnomAD
        (170, 455 - 53, 11, versions["gnomad_version"]),
        # dbSNP
        (170, 443 - 53, 11, versions["dbsnp_version"]),
        # SIFT
        (170, 431 - 53, 11, versions["sift_version"]),
        # PolyPhen2
        (170, 419 - 53, 11, versions["polyphen2_version"]),
    ]
...
def generate(
    *,
    ...
    input_pdf_path = f"{module_dir}/ID_Genome Report_Positive-GENERIC-TABLE.pdf"
    ...
    _overlay_pdf_with_annotations(
        ...
        f"{module_dir}/ID_Genome Report_Positive-GENERIC-REST.pdf",
