...
def _create_annotations(
    ...
    _static_text_page_2 = [
        ...
        (538, 223, 11, True, validated_by),
        (538, 191, 11, True,  validated_at),
    ]
    _static_text_page_3 = []
    _static_text_page_4 = [
        # ClinVar
...
def generate(
    *,
    ...
    if variant_validations:
        ...
        result_annotation = [
            (74, (420 - i*13), 11, False, v.get("validationComment", ""))
    ...
    input_pdf_path = f"{module_dir}/EN_Genome Report_Positive_MD-TABLE.pdf"
    ...
    _overlay_pdf_with_annotations(
        ...
        f"{module_dir}/EN_Genome Report_Positive_MD-REST.pdf",
    ...
    result_file_name = f"/tmp/{str(uuid.uuid4())}.pdf"
    ...
    print(f"Generated report successfully - {result_file_name}")
