...
def _create_annotations(
    ...
    _text_field_positions_page_1 = [
        ...
        (69, 360, 472, 120, 12, "", 1 << 12),
        # Recommendation
        (69, 140, 472, 120, 12, "", 1 << 12),
    ]
...
def generate(
    *,
    ...
    input_pdf_path = f"{module_dir}/ID_Genome Report_Positive_MD_TABLE.pdf"
    ...
    _create_annotations(output_pdf_annotations, versions, project, vcf, validated_by, validated_at, qc_note)
    _overlay_pdf_with_annotations(
        output_pdf_annotations,
        f"{module_dir}/ID_Genome Report_Positive_MD_REST.pdf",
