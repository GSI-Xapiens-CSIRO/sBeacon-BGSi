...
def _create_annotations(
    ...
    _static_text_page_4 = [
        ...
        (170, 479 - 53, 11, "vOMIM"),
        # ClinVar
        (170, 467 - 53, 11, "vClinvar"),
        # gnomAD
        (170, 455 - 53, 11, "vgnomAD"),
        # dbSNP
        (170, 443 - 53, 11, "vdbSNP"),
        # SIFT
        (170, 431 - 53, 11, "vSIFT"),
        # PolyPhen2
        (170, 419 - 53, 11, "vPolyPhen2"),
    ]
...
def generate(*, variants=None):
    ...
    _create_pdf_with_table(
        output_pdf_annotations, header_rows, [80, 68, 33, 58, 93, 37, 37, 93], data
    )
