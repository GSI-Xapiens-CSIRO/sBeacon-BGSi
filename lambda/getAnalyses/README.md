...
## Overview
Handles queries for analysis records in the sBeacon API.

## Routes

| Path | Method | Middleware |
|------|--------|------------|
| `/analyses` | POST | Permission + Quota |
| `/analyses/filtering_terms` | POST | Permission + Quota |
| `/analyses/{id}` | POST | Permission + Quota |
| `/analyses/{id}/g_variants` | POST | Permission + Quota |
