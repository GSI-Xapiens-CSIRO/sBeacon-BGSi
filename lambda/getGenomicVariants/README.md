...
## Overview
Handles queries for genomic variant records in the sBeacon API.

## Routes

| Path | Method | Middleware |
|------|--------|------------|
| `/g_variants` | POST | Permission + Quota |
| `/g_variants/{id}` | POST | Permission + Quota |
| `/g_variants/{id}/individuals` | POST | Permission + Quota |
| `/g_variants/{id}/biosamples` | POST | Permission + Quota |
